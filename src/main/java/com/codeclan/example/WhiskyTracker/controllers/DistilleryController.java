...
public class DistilleryController {
    ...
    public ResponseEntity<List<Distillery>> findDistilleries(
    ...
    public ResponseEntity<List<Distillery>> findDistilleriesByWhisky(
            @RequestParam(name = "age") Integer age
    ){
        return new ResponseEntity<List<Distillery>>(distilleryRepository.findDistilleryByWhiskiesAge(age),HttpStatus.OK);
    }
}
